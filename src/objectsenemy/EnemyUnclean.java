...
public class EnemyUnclean extends BaseObject {
	...
	//Variables
		...
		private BufferedImage enemyunclean[] = new BufferedImage[3];
		 ...
		 */
		public EnemyUnclean(float x, float y, ID id, SpriteCuter imageCut_enemy, GameHandler handler, 
			...
			enemyunclean[0] = imageCut.grabImage(1, 2, 33, 32);
			enemyunclean[1] = imageCut.grabImage(2, 2, 33, 32);
			enemyunclean[2] = imageCut.grabImage(3, 2, 33, 32);
			
			animation = new Animation2D(3, enemyunclean);
		}
		...
		public void render(Graphics graphics) {
			...
			//Enemy
			if (velX == 0 && velY == 0) {
				graphics.drawImage(enemyunclean[0], (int)x, (int)y, null);
			}
			else { 
