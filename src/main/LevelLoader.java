...
public class LevelLoader {
	...
	//LevelLoader variables
		...
		public LevelLoader(Handler handler, Game game, Camera camera, Hud hud){
			...
			BufferedImageLoader loader = new BufferedImageLoader();
				...
				//level_2 = loader.loadImage("/...2.png"); 	//lvl 2
				//level_3 = loader.loadImage("/...3.png"); 	//lvl 3
			...
			for (int xx = 0; xx < w; xx++){
				for (int yy = 0; yy < h; yy++){
					...
					if (red == 0 && green == 0 && blue == 255){
						handler.addObject(new SpaceMarine(xx*32, yy*32, ID.SpaceMarine, cut, handler, camera, game, hud));
					}
